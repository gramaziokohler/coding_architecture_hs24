...
CALL "%CONDA_COMMAND%" create -c conda-forge -n %CONDA_ENV_NAME% "compas>=2.4,<3" python=3.10 -y >nul 2>&1
...
<nul set /p"=[√] Successfully installed Coding Architecture tools on Rhino"
ECHO.
